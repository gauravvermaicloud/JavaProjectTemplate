...
public class TestBoilerplateList {
	...
	public void testToString(){
		BoilerplateList<Integer> boilerplateSet = new BoilerplateList<>();
		for(int i=1;i<3;i++){
	...
	public void testCollectionConstructor(){
		...
		BoilerplateList<InternalBaseExtender> boilerplateSet
			= new BoilerplateList<>(arrayList);
	...
	public void testEqualsPositiveCase(){
		...
		BoilerplateList<InternalBaseExtender> boilerplateSet1
			= new BoilerplateList<>(arrayList);	
		BoilerplateList<InternalBaseExtender> boilerplateSet2 = boilerplateSet1;
	...
	public void testEqualsPositiveCaseWhenSameObjectsArePresent(){
		...
		BoilerplateList<InternalBaseExtender> boilerplateSet2 =
			new BoilerplateList<>();
	...
	public void testClone(){
		...
		BoilerplateList<InternalBaseExtender> boilerplateSet1
			= new BoilerplateList<>(arrayList);	
		BoilerplateList<InternalBaseExtender> boilerplateSet2 = boilerplateSet1.clone();
